      ...
      <div className="flex-1 px-12 py-7">
        <header>
          <div className="flex items-start gap-2.5">
            <h1 className="font-heading text-[40px] leading-none tracking-[-0.03em] text-black">TODAY</h1>
            <span className="pt-1 text-[32px] leading-none">🐕</span>
          </div>
        ...
        <div className="mt-9 space-y-8 pb-12">
          ...
          <DailySection title="OVERDUE" todos={overdueTodos} showOverdueActions />
        </div>
      </div>
    </section>
  )
